...
<body>
    <div class="mainmenu">
        <ul>
            ...
            <!--<li><a href="../Mini_project_final/services.php"><i class="fa fa-stop-circle" aria-hidden="true"></i>
                    Services</a></li>-->
            <li><a href="../Mini_project_final/registration.php"><i class="fa fa-bed" aria-hidden="true"></i>
                    Register</a></li>
  ...
  <button type="submit" style=" padding: 10px 50px;" ><a href="../Mini_project_final/services.php">Make Booking</a></button>
     </div> -->
     
     <h2 class="abc" >Please Enter Register Details for Booking</h2>
   <!-- Footer   -->
