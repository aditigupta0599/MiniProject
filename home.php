    ...
    <div class="mainmenu">
        <ul>
            ...
            <li class="active"><a href="../Mini_project_final/home.php"><i class="fa fa-home" aria-hidden="true"></i>
                    Home</a></li>
            <li><a href="../Mini_project_final/blog2.php"><i class="fa fa-rss" aria-hidden="true"></i>
                    Blog</a></li>
            <li><a href="../Mini_project_final/registration.php"><i class="fa fa-stop-circle" aria-hidden="true"></i>
                    Services</a></li>
            <li><a href="../Mini_project_final/book.php"><i class="fa fa-bed" aria-hidden="true"></i>
                    Book Now</a></li>
            <li><a href="../Mini_project_final/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i>
                    Log Out</a></li>
